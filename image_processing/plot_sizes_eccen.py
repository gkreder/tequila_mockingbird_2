...
def filter_intensities(intensities):
	...
	filtered_intensities = filtered_intensities[int(len(filtered_intensities) * .00) : int(len(filtered_intensities) * 1.0)]
...
# LSM1
# ------------------------------------------------------------------------------------------------
PERTURB_sizes = filter_intensities(pickle.load(open('PERTURB_sizes.pkl')))
DMSO_sizes = filter_intensities(pickle.load(open('DMSO_sizes.pkl')))
PERTURB_eccentricities= filter_intensities(pickle.load(open('PERTURB_eccentricities.pkl')))
DMSO_eccentricities = filter_intensities(pickle.load(open('DMSO_eccentricities.pkl')))
...
# plot_intensity_hist(DMSO_sizes, PERTURB_sizes, 'DMSO CONTROL', 'PERTURB')
plot_intensity_hist(DMSO_eccentricities, PERTURB_eccentricities, 'DMSO CONTROL', 'PERTURB')
